...
<div class="container">
    <div class="marketing">
        <h1>Un vistazo rápido a CS Academia</h1>
        <p class="marketing-byline">Por qué, para qué y cómo.</p>

        <div class="row-fluid">
            <div class="span4">
                <img class="marketing-img" src="../assets/img/logo.png">
                <h2>Mejorar la gestión</h2>
